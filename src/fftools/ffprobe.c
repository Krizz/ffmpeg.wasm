...
/* ffmpeg.wasm: renamed to avoid colliding with ffmpeg.c's definitions, since
 * both translation units are linked into a single wasm module. */
...
/* ffmpeg.wasm: renamed to avoid colliding with ffmpeg_opt.c's
 * show_help_default() in the combined wasm module. */
